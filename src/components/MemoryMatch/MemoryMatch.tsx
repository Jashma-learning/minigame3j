    ...
    <div className="flex flex-col items-center gap-6 p-8">
      <div className="text-center">
        ...
        <div className="flex gap-4 mb-4">
          <div className="px-4 py-2 bg-blue-100 rounded">Moves: {moves}</div>
          <div className="px-4 py-2 bg-green-100 rounded">Matches: {matches}</div>
          {timeLeft !== null && (
            <div className={`px-4 py-2 rounded ${timeLeft < 10 ? 'bg-red-100' : 'bg-yellow-100'}`}>
              Time: {timeLeft}s
            </div>
          )}
        </div>
